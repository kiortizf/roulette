    ...
    <div className="glass-dark rounded-2xl p-6">
      ...
      <div className="space-y-4 max-h-[600px] overflow-y-auto pr-2">
        {history.map((session, index) => {
          ...
          const winnerVotes = session.votes?.[session.winner.id];
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 text-xs text-gray-400 mb-2">
                    {session.winner.vote_average != null && (
                      <span className="text-yellow-400">
                        ⭐ {session.winner.vote_average.toFixed(1)}
                      </span>
                    )}
                    {session.winner.release_date && (
                      <span>
                  ...
                  {/* Vote score */}
                  {winnerVotes != null && winnerVotes !== 0 && (
                    <div className="mt-2">
                      <span className={`text-xs px-2 py-1 rounded-full ${
                        ...
                        {winnerVotes > 0 ? '+' : ''}{winnerVotes} votes
                      </span>
                    </div>
                  )}
                </div>
